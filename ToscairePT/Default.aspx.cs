...
namespace ToscairePT
{
    public partial class _Default : Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataTable[] tables = refs.individualSummary(date, true, "65E21CF6-5D23-4940-BA05-BD1F281DFC75");
            ...
            //List<Guid> x1 = new List<Guid>();
            //foreach (DataRow dr in tables[3].Rows)
            //{
            //    x1.Add(dr.Field<Guid>(0));
            //    y.Add(dr.Field<int>(1));
            //}
            //GridView4.DataSource = tables[3];
            //GridView4.DataBind();
            //Chart4.DataSource = tables[3];
            //Chart4.DataBind();
            ////=table.Rows.OfType<DataRow>().Select(dr => dr.Field<int>(0)).ToList();
            //Chart4.Series["Default"].Points.DataBindXY(x, y);
            //// Set Doughnut chart type
            //Chart4.Series["Default"].ChartType = System.Web.UI.DataVisualization.Charting.SeriesChartType.Pie;

            //// Set labels style
            //Chart4.Series["Default"]["PieLabelStyle"] = "Outside";

            //// Set Doughnut radius percentage
            //Chart4.Series["Default"]["DoughnutRadius"] = "30";

            //// Explode data point with label "Italy"
            //Chart4.Series["Default"].Points[4]["Exploded"] = "true";
            //// Set drawing style
            //Chart4.Series["Default"]["PieDrawingStyle"] = "SoftEdge";
